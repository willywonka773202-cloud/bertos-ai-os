...
interface UIStore {
  ...
  activeView: 'dashboard' | 'chat' | 'hermes' | 'prompts' | 'compare' | 'coding' | 'max' | 'workspace' | 'evolution' | 'agents' | 'skills' | 'plugins' | 'outputs' | 'runs' | 'studio' | 'content-lab' | 'inbox-deals' | 'publishing-queue' | 'memory' | 'memory-review' | 'brief' | 'playbooks' | 'tasks' | 'migrations' | 'github' | 'settings' | 'launch' | 'autopilot'
